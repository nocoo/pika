...
import type { ProjectItem, ProjectSourceCount } from "@/lib/projects-types";
...
export function ProjectSidebar({
  ...
  if (projects.length === 0) {
    return (
      <div
        ...
        data-testid="project-sidebar-empty"
      >
  ...
  return (
    <div
      className="flex flex-col gap-4 lg:flex-1 lg:overflow-y-auto p-0.5"
