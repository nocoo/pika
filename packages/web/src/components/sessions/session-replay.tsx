...
export function SessionReplay({
  ...
  return (
    ...
    >
      ...
      {loadingContent && (
        <div className="flex flex-col gap-4" data-testid="replay-loading">
      ...
      {contentError && (
        <div
          className="rounded-xl border border-destructive/20 bg-destructive/5 px-4 py-6 text-center text-sm text-destructive"
      ...
      {!contentUrl && !loadingContent && (
        <div
          className="rounded-xl bg-secondary px-4 py-12 text-center text-sm text-muted-foreground"
