...
export function TagsSettingsPage() {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-2xl" data-testid="tags-page">
      <div>
      ...
      {error && (
        <div className="text-sm text-destructive py-2" data-testid="tags-error">
          {error}
        </div>
      )}

      <div
        className="flex flex-col gap-3 rounded-[var(--radius-card)] bg-secondary p-4"
      ...
      >
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            title="No color"
            aria-label="No color"
            data-testid="new-tag-color-none"
          />
          {PRESET_COLORS.map((c) => (
            <button
              type="button"
      ...
      {loading ? (
        <div className="flex flex-col gap-2" data-testid="tags-loading">
        ...
        <div className="flex flex-col gap-1" data-testid="tags-list">
          {tags.map((tag) => (
            <div
              key={tag.id}
