...
import { fileUnchanged, type FileFingerprint } from "./file-changed.js";
...
describe("fileUnchanged", () => {
  ...
  it("returns false when inode differs (file replaced/rotated)", () => {
  ...
  it("returns false when size differs (in-place overwrite)", () => {
